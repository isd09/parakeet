...
const availableCDNs = [
    `https://raw.githubusercontent.com/isd09/parakeet/refs/heads/${isDev ? "dev" : "main"}/`,
    `https://cdn.jsdelivr.net/gh/isd09/parakeet@${isDev ? "dev" : "master"}/`,
    `https://cdn.statically.io/gh/isd09/parakeet/refs/heads/${isDev ? "dev" : "main"}/`
];
...
.then(async () => {
    ...
    sendToast("🌿 Parakeet loaded successfully!");
